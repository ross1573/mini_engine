...
template <NonRefT T> requires DerivedFromT<T, IUnknown>
template <DerivedFromT<IUnknown> U> 
[[force_inline]] constexpr SharedPtr<T>::SharedPtr(SharedPtr<T> const& other, Ptr ptr) noexcept
    : m_Ptr(ptr)
{
    if (m_Ptr)
    {
...
template <NonRefT T> requires DerivedFromT<T, IUnknown>
template <DerivedFromT<IUnknown> U>
[[force_inline]] constexpr SharedPtr<T>::SharedPtr(SharedPtr<T>&& other, Ptr ptr) noexcept
    : m_Ptr(ptr)
{
    other.m_Ptr = nullptr;
}
...
[[force_inline]] constexpr bool operator==(SharedPtr<T> const& l, U* r) noexcept
...
template <NonRefT T, NonRefT U>
[[force_inline]] constexpr auto operator<=>(SharedPtr<T> const l, U* r) noexcept
    requires DerivedFromT<T, IUnknown>&& DerivedFromT<U, IUnknown>
{
    return l.Get <=> r;
}
...
template <NonRefT T, NonRefT U>
[[force_inline]] constexpr SharedPtr<T> StaticCast(SharedPtr<U>&& other)
    requires DerivedFromT<T, IUnknown>&& DerivedFromT<U, IUnknown>
{
