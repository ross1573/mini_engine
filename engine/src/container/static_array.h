...
[[force_inline]] constexpr StaticArray<T, N>::StaticArray() noexcept
    : m_Size(0)
    , m_Buffer()
{
}
...
template <MovableT T, SizeT N>
template <ForwardIteratableByT<T> Iter>
[[force_inline]] constexpr StaticArray<T, N>::StaticArray(Iter first, Iter last)
{
    AddRange(first, last);
}
...
template <MovableT T, SizeT N>
template <typename... Args> requires ConstructibleFromT<T, Args...>
[[force_inline]] constexpr void StaticArray<T, N>::Insert(SizeT index, Args&&... args)
{
...
template <MovableT T, SizeT N>
template <ForwardIteratableByT<T> Iter>
[[force_inline]] constexpr void StaticArray<T, N>::Assign(Iter first, Iter last)
{
...
template <MovableT T, SizeT N>
[[force_inline]] constexpr void StaticArray<T, N>::RemoveAt(SizeT index)
{
...
template <MovableT T, SizeT N>
[[force_inline]] constexpr void StaticArray<T, N>::RemoveRange(SizeT first, SizeT last)
{
...
template <MovableT T, SizeT N>
[[force_inline]] constexpr void StaticArray<T, N>::Clear()
{
...
template <MovableT T, SizeT N>
[[force_inline]] constexpr StaticArray<T, N>::Ptr StaticArray<T, N>::Data() noexcept
{
    return m_Buffer.Data();
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr StaticArray<T, N>::ConstPtr StaticArray<T, N>::Data() const noexcept
{
    return m_Buffer.Data();
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr StaticArray<T, N>::Iterator StaticArray<T, N>::Begin() noexcept
{
    return Iterator(m_Buffer.Data(), 0, this);
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr StaticArray<T, N>::ConstIterator StaticArray<T, N>::Begin() const noexcept
{
    return ConstIterator(m_Buffer.Data(), 0, this);
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr StaticArray<T, N>::Iterator StaticArray<T, N>::End() noexcept
{
    return Iterator(m_Buffer.Data() + m_Size, 0, this);
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr StaticArray<T, N>::ConstIterator StaticArray<T, N>::End() const noexcept
{
    return ConstIterator(m_Buffer.Data() + m_Size, 0, this);
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr T& StaticArray<T, N>::First()
{
    return At(0);
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr T const& StaticArray<T, N>::First() const
{
    return At(0);
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr T& StaticArray<T, N>::Last()
{
    return At(m_Size - 1);
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr T const& StaticArray<T, N>::Last() const
{
    return At(m_Size - 1);
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr T& StaticArray<T, N>::At(SizeT index)
{
...
template <MovableT T, SizeT N>
[[force_inline]] constexpr T const& StaticArray<T, N>::At(SizeT index) const
{
    AssertValidIndex(index);
    return *(m_Buffer.Data() + index);
}
...
template <MovableT T, SizeT N>
[[force_inline]] consteval SizeT StaticArray<T, N>::Capacity() const noexcept
{
    return m_Buffer.Capacity();
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr SizeT StaticArray<T, N>::Size() const noexcept
{
    return m_Size.Get();
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr bool StaticArray<T, N>::IsEmpty() const noexcept
{
    return m_Size == 0;
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr bool StaticArray<T, N>::IsFull() const noexcept
{
    return (SizeT)m_Size == m_Buffer.Capacity();
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr bool StaticArray<T, N>::IsValidIndex(SizeT index) const noexcept
{
    return index < m_Size;
}

template <MovableT T, SizeT N>
[[force_inline]] constexpr bool StaticArray<T, N>::IsValidIterator(ConstIterator iter) const noexcept
{
...
template <MovableT T, SizeT N>
[[force_inline]] constexpr T& StaticArray<T, N>::operator[](SizeT index)
{
    AssertValidIndex(index);
    return *(m_Buffer.Data() + index);
}
...
template <MovableT T, SizeT N>
[[force_inline]] constexpr T const& StaticArray<T, N>::operator[](SizeT index) const
{
    AssertValidIndex(index);
    return *(m_Buffer.Data() + index);
}
