...
template <ForwardIteratorT T>
[[force_inline]] constexpr MoveIterator<T>::MoveIterator(T iter)
    : m_Iter(iter)
{
}
...
template <ForwardIteratorT T>
template <ForwardIteratorT U>
[[force_inline]] constexpr MoveIterator<T>::MoveIterator(MoveIterator<U> const& o)
    requires ConvertibleToT<U const&, T>
: m_Iter(o.m_Iter)
{
}
...
template <ForwardIteratorT T>
template <ForwardIteratorT U>
[[force_inline]] constexpr MoveIterator<T>& MoveIterator<T>::operator=(MoveIterator<U> const& o)
    requires ConvertibleToT<U const&, T>
{
    m_Iter = o.m_Iter;
    return *this;
...
template <ForwardIteratorT T>
[[force_inline]] constexpr T const& MoveIterator<T>::Base() const& noexcept
{
    return m_Iter;
}

template <ForwardIteratorT T>
[[force_inline]] constexpr T MoveIterator<T>::Base() && noexcept
{
    return MoveArg(m_Iter);
}

template <ForwardIteratorT T>
[[force_inline]] constexpr MoveIterator<T>::Ptr MoveIterator<T>::Address() const noexcept
{
    return m_Iter.Address();
}

template <ForwardIteratorT T>
[[force_inline]] constexpr bool MoveIterator<T>::IsValid() const
{
    return m_Iter.IsValid();
}

template <ForwardIteratorT T>
[[force_inline]] constexpr bool MoveIterator<T>::IsValidWith(MoveIterator const& o) const
{
    return m_Iter.IsValidWith(o.Base());
}

template <ForwardIteratorT T>
[[force_inline]] constexpr bool MoveIterator<T>::Increment()
{
    return m_Iter.Increment();
}

template <ForwardIteratorT T>
[[force_inline]] constexpr bool MoveIterator<T>::Decrement()
...
template <ForwardIteratorT T>
[[force_inline]] constexpr bool MoveIterator<T>::Advance(OffsetT s)
...
template <ForwardIteratorT T>
[[force_inline]] constexpr MoveIterator<T>::Ptr MoveIterator<T>::operator->() const
{
    return m_Iter.operator->();
}

template <ForwardIteratorT T>
[[force_inline]] constexpr MoveIterator<T>::Ref MoveIterator<T>::operator*() const
{
    return static_cast<Ref>(*m_Iter);
}

template <ForwardIteratorT T>
[[force_inline]] constexpr MoveIterator<T>::Ref MoveIterator<T>::operator[](OffsetT n) const
    requires RandomAccessIteratorT<T>
{
...
template <ForwardIteratorT T>
[[force_inline]] constexpr MoveIterator<T>& MoveIterator<T>::operator++()
{
    ++m_Iter;
    return *this;
}
...
template <ForwardIteratorT T>
[[force_inline]] constexpr MoveIterator<T> MoveIterator<T>::operator++(int)
{
...
template <ForwardIteratorT T>
[[force_inline]] constexpr MoveIterator<T>& MoveIterator<T>::operator+=(OffsetT n)
    requires RandomAccessIteratorT<T>
{
    m_Iter += n;
    return *this;
...
template <ForwardIteratorT T>
[[force_inline]] constexpr MoveIterator<T> MoveIterator<T>::operator+(OffsetT n) const
    requires RandomAccessIteratorT<T>
{
    MoveIterator t(*this);
    t += n;
...
[[force_inline]] constexpr MoveIterator<T> operator+(OffsetT n, MoveIterator<T> i)
{
    return i + n;
}

template <RandomAccessIteratorT T, RandomAccessIteratorT U>
[[force_inline]] constexpr OffsetT operator-(MoveIterator<T> const& l, MoveIterator<U> const& r)
{
    return l.Base() - r.Base();
}

template <ForwardIteratorT T, ForwardIteratorT U>
[[force_inline]] constexpr bool operator==(MoveIterator<T> const& l, MoveIterator<U> const& r)
{
    return l.Base() == r.Base();
}
...
template <RandomAccessIteratorT T, RandomAccessIteratorT U>
[[force_inline]] constexpr auto operator<=>(MoveIterator<T> const& l, MoveIterator<U> const& r)
