...
class CircularIterator
{
    ...
    using VersionT = detail::IteratorVersion<CircularT>;
...
[[force_inline]] constexpr CircularIterator<T, CircularT>::CircularIterator() noexcept
    : m_Offset(0)
    , m_Capacity(0)
    , m_Begin(nullptr)
    , m_Circular(nullptr)
...
template <typename T, typename CircularT>
template <typename U, typename CircularU>
[[force_inline]] constexpr CircularIterator<T, CircularT>&
...
template <typename T, typename CircularT>
[[force_inline]] constexpr CircularIterator<T, CircularT>::Ptr
...
template <typename T, typename CircularT>
[[force_inline]] constexpr bool CircularIterator<T, CircularT>::IsValid() const noexcept
{
...
template <typename T, typename CircularT>
[[force_inline]] constexpr bool CircularIterator<T, CircularT>::Reset() noexcept
{
...
template <typename T, typename CircularT>
[[force_inline]] constexpr bool CircularIterator<T, CircularT>::Finish() noexcept
{
    if (m_Circular == nullptr) [[unlikely]]
    {
        return false;
...
template <typename T, typename CircularT>
[[force_inline]] constexpr bool CircularIterator<T, CircularT>::Increment() noexcept
{
...
template <typename T, typename CircularT>
[[force_inline]] constexpr bool CircularIterator<T, CircularT>::Advance(OffsetT d) noexcept
{
...
template <typename T, typename CircularT>
[[force_inline]] constexpr T* CircularIterator<T, CircularT>::operator->() const noexcept
{
...
[[force_inline]] constexpr OffsetT operator-(CircularIterator<T, CircularT> const& l,
...
template <typename T, typename CircularT, typename U, typename CircularU>
[[force_inline]] constexpr bool operator==(CircularIterator<T, CircularT> const& l,
                                           CircularIterator<U, CircularU> const& r) noexcept
...
template <typename T, typename CircularT, typename U, typename CircularU>
[[force_inline]] constexpr auto operator<=>(CircularIterator<T, CircularT> const& l,
                                            CircularIterator<U, CircularU> const& r) noexcept
