...
class ArrayIterator
{
    ...
    using VersionT = detail::IteratorVersion<ArrayT>;
...
[[force_inline]] constexpr ArrayIterator<T, ArrayT>::ArrayIterator() noexcept
    : m_Ptr(nullptr)
    , m_Array(nullptr)
    , m_Version(0)
{
...
template <typename T, typename ArrayT>
[[force_inline]] constexpr ArrayIterator<T, ArrayT>::ArrayIterator(Ptr ptr, SizeT ver,
...
template <typename T, typename ArrayT>
template <typename U, typename ArrayU>
[[force_inline]] constexpr ArrayIterator<T, ArrayT>&
...
template <typename T, typename ArrayT>
[[force_inline]] constexpr ArrayIterator<T, ArrayT>::Ptr
...
template <typename T, typename ArrayT>
[[force_inline]] constexpr bool ArrayIterator<T, ArrayT>::IsValid() const noexcept
{
    return CheckIterator(*this);
}

template <typename T, typename ArrayT>
[[force_inline]] constexpr bool ArrayIterator<T, ArrayT>::IsValidWith(ArrayIterator const& o) const noexcept
{
    return CheckSource(o);
}

template <typename T, typename ArrayT>
[[force_inline]] constexpr bool ArrayIterator<T, ArrayT>::Reset() noexcept
{
...
template <typename T, typename ArrayT>
[[force_inline]] constexpr bool ArrayIterator<T, ArrayT>::Finish() noexcept
{
    if (m_Array == nullptr) [[unlikely]]
    {
        return false;
...
template <typename T, typename ArrayT>
[[force_inline]] constexpr bool ArrayIterator<T, ArrayT>::Increment() noexcept
{
...
template <typename T, typename ArrayT>
[[force_inline]] constexpr bool ArrayIterator<T, ArrayT>::Decrement() noexcept
{
    if (!CheckIterator(*this - 1)) [[unlikely]]
    {
        return false;
...
template <typename T, typename ArrayT>
[[force_inline]] constexpr bool ArrayIterator<T, ArrayT>::Advance(OffsetT d) noexcept
{
...
template <typename T, typename ArrayT>
[[force_inline]] constexpr T* ArrayIterator<T, ArrayT>::operator->() const noexcept
{
...
template <typename T, typename ArrayT>
[[force_inline]] constexpr T& ArrayIterator<T, ArrayT>::operator[](OffsetT const o) const noexcept
{
...
template <typename T, typename ArrayT>
[[force_inline]] constexpr ArrayIterator<T, ArrayT>& ArrayIterator<T, ArrayT>::operator++() noexcept
{
    ++m_Ptr;
    return *this;
}
...
template <typename T, typename ArrayT>
[[force_inline]] constexpr ArrayIterator<T, ArrayT>& ArrayIterator<T, ArrayT>::operator+=(OffsetT d) noexcept
{
    m_Ptr += d;
    return *this;
}
...
template <typename T, typename ArrayT>
[[force_inline]] constexpr ArrayIterator<T, ArrayT> ArrayIterator<T, ArrayT>::operator++(int) noexcept
{
...
template <typename T, typename ArrayT>
[[force_inline]] constexpr ArrayIterator<T, ArrayT> ArrayIterator<T, ArrayT>::operator+(OffsetT d) const noexcept
{
    ArrayIterator t(*this);
    t.m_Ptr += d;
    return t;
...
[[force_inline]] constexpr OffsetT operator-(ArrayIterator<T, ArrayT> const& l,
...
template <typename T, typename U, typename ArrayT, typename ArrayU>
[[force_inline]] constexpr bool operator==(ArrayIterator<T, ArrayT> const& l,
                                           ArrayIterator<U, ArrayU> const& r) noexcept
...
template <typename T, typename U, typename ArrayT, typename ArrayU>
[[force_inline]] constexpr auto operator<=>(ArrayIterator<T, ArrayT> const& l,
                                            ArrayIterator<U, ArrayU> const& r) noexcept
