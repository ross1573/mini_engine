...
#include "container/iterator/array_iterator.h"
...
public:
    ...
    constexpr ~Array();
    constexpr Array(Array const&) requires CopyableT<T>;
    constexpr Array(Array const&, AllocT const&) requires CopyableT<T>;
    ...
    constexpr Array& operator=(Array const&) requires CopyableT<T>;
...
[[force_inline]] constexpr Array<T, AllocT>::Array() noexcept
    : m_Version(0)
    , m_Size(0)
    , m_Buffer()
{
...
template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr Array<T, AllocT>::Array(Array&& other) noexcept
    : m_Version(0)
...
template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr Array<T, AllocT>::Array(Array&& other, AllocT const& alloc) noexcept
    : m_Version(0)
    , m_Size(Exchange(other.m_Size, SizeT(0)))
...
template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr Array<T, AllocT>::Array(AllocT const& alloc) noexcept
    : m_Version(0)
    , m_Size(0)
    , m_Buffer(alloc)
{
...
template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr Array<T, AllocT>::Array(AllocT&& alloc) noexcept
    : m_Version(0)
    , m_Size(0)
...
constexpr void Array<T, AllocT>::Resize(SizeT size, Args&&... args)
{
    ...
    if (m_Size < size)
    {
        ...
        {
            memory::ConstructRangeArgs(begin + m_Size, begin + size,
                                       ForwardArg<Args>(args)...);
        }
    }
    else
...
template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr void Array<T, AllocT>::Clear()
{
...
template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr void Array<T, AllocT>::Swap(Array& other) noexcept
{
...
template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr Array<T, AllocT>::Ptr Array<T, AllocT>::Data() noexcept
{
    return m_Buffer.Data();
}

template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr Array<T, AllocT>::ConstPtr Array<T, AllocT>::Data() const noexcept
{
    return m_Buffer.Data();
}

template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr Array<T, AllocT>::Iterator Array<T, AllocT>::Begin() noexcept
{
    return Iterator(m_Buffer.Data(), m_Version, this);
}

template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr Array<T, AllocT>::ConstIterator Array<T, AllocT>::Begin() const noexcept
{
    return ConstIterator(m_Buffer.Data(), m_Version, this);
}

template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr Array<T, AllocT>::Iterator Array<T, AllocT>::End() noexcept
{
    return Iterator(m_Buffer.Data() + m_Size, m_Version, this);
}

template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr Array<T, AllocT>::ConstIterator Array<T, AllocT>::End() const noexcept
{
    return ConstIterator(m_Buffer.Data() + m_Size, m_Version, this);
}

template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr T& Array<T, AllocT>::First()
{
    return At(0);
}

template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr T const& Array<T, AllocT>::First() const
{
    return At(0);
}

template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr T& Array<T, AllocT>::Last()
{
    return At(m_Size - 1);
}

template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr T const& Array<T, AllocT>::Last() const
{
    return At(m_Size - 1);
}

template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr T& Array<T, AllocT>::At(SizeT index)
{
...
template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr T const& Array<T, AllocT>::At(SizeT index) const
{
    AssertValidIndex(index);
    return *(m_Buffer.Data() + index);
}
...
template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr SizeT Array<T, AllocT>::Size() const noexcept
{
    return m_Size;
}

template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr SizeT Array<T, AllocT>::Capacity() const noexcept
{
    return m_Buffer.Capacity();
}

template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr bool Array<T, AllocT>::IsEmpty() const noexcept
{
    return m_Size == 0;
}

template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr bool Array<T, AllocT>::IsValidIndex(SizeT index) const noexcept
{
    return index < m_Size;
}

template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr bool Array<T, AllocT>::IsValidIterator(ConstIterator iter) const noexcept
{
...
template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr T& Array<T, AllocT>::operator[](SizeT index)
{
    AssertValidIndex(index);
    return *(m_Buffer.Data() + index);
}
...
template <MovableT T, AllocatorT<T> AllocT>
[[force_inline]] constexpr T const& Array<T, AllocT>::operator[](SizeT index) const
{
    AssertValidIndex(index);
    return *(m_Buffer.Data() + index);
}
