...
[[force_inline]] constexpr UniquePtr<T, DelT>::UniquePtr() noexcept
    : m_Ptr(nullptr)
    , m_Deleter{}
{
}
...
template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr UniquePtr<T, DelT>::~UniquePtr()
{
    m_Deleter(m_Ptr);
    m_Ptr = nullptr;
}
...
template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr UniquePtr<T, DelT>::UniquePtr(UniquePtr&& other) noexcept
    : m_Ptr(other.m_Ptr)
...
template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr UniquePtr<T, DelT>::UniquePtr(Ptr ptr) noexcept
    : m_Ptr(ptr)
    , m_Deleter{}
{
}
...
template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr UniquePtr<T, DelT>::UniquePtr(Ptr ptr, DelT const& del) noexcept
    : m_Ptr(ptr)
    , m_Deleter(del)
{
}
...
template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr UniquePtr<T, DelT>::UniquePtr(Ptr ptr, DelT&& del) noexcept
    : m_Ptr(ptr)
...
template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr UniquePtr<T, DelT>::UniquePtr(NullptrT) noexcept
    : m_Ptr(nullptr)
    , m_Deleter{}
{
}
...
template <NonRefT T, DeleterT<T> DelT>
template <PtrConvertibleToT<T> U, DeleterT<U> DelU>
[[force_inline]] constexpr UniquePtr<T, DelT>::UniquePtr(UniquePtr<T, DelU>&& other)
...
template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr UniquePtr<T, DelT>::Ptr UniquePtr<T, DelT>::Get() const noexcept
{
    return m_Ptr;
}

template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr bool UniquePtr<T, DelT>::IsValid() const noexcept
{
    return m_Ptr != nullptr;
}

template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr UniquePtr<T, DelT>::Ptr UniquePtr<T, DelT>::Detach() noexcept
{
    Ptr tmp = m_Ptr;
    m_Ptr = nullptr;
    return tmp;
...
template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr void UniquePtr<T, DelT>::Swap(UniquePtr& other) noexcept
{
...
template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr void UniquePtr<T, DelT>::Reset(NullptrT) noexcept
{
    m_Deleter(m_Ptr);
    m_Ptr = nullptr;
}
...
template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr void UniquePtr<T, DelT>::Reset(Ptr ptr) noexcept
{
    m_Deleter(m_Ptr);
    m_Ptr = ptr;
}
...
template <NonRefT T, DeleterT<T> DelT>
template <PtrConvertibleToT<T> U>
[[force_inline]] constexpr void UniquePtr<T, DelT>::Reset(U* ptr) noexcept
{
    m_Deleter(m_Ptr);
...
template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr UniquePtr<T, DelT>::Ptr UniquePtr<T, DelT>::operator->() const noexcept
{
    return m_Ptr;
}

template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr UniquePtr<T, DelT>::Ref UniquePtr<T, DelT>::operator*() const noexcept
{
    return *(m_Ptr);
}

template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr UniquePtr<T, DelT>::operator bool() const noexcept
{
    return m_Ptr != nullptr;
}

template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr UniquePtr<T, DelT>::operator Ptr() const noexcept
{
    return m_Ptr;
}

template <NonRefT T, DeleterT<T> DelT>
[[force_inline]] constexpr UniquePtr<T, DelT>&
