...
macro (_get_output_directory_impl archive_out library_out runtime_out)
    ...
    set(${archive_out} "${ENGINE_ARCHIVE_DIR}/${target_arch}_${config_lower}")
    set(${library_out} "${ENGINE_LIBRARY_DIR}/${target_arch}_${config_lower}")
    set(${runtime_out} "${ENGINE_RUNTIME_DIR}/${target_arch}_${config_lower}")
endmacro()
